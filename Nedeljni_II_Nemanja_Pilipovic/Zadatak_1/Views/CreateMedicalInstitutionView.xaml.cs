...
{
    /// <summary>
    /// Interaction logic for CreateMedicalInstitutionView.xaml
    /// </summary>
    public partial class CreateMedicalInstitutionView : Window
    {
        public CreateMedicalInstitutionView()
        {
            InitializeComponent();
            this.DataContext = new CreateMedicalInstitutionViewModel(this);
        }
