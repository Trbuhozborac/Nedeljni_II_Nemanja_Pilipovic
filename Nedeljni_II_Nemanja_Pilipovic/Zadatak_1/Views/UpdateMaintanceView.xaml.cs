...
{
    /// <summary>
    /// Interaction logic for UpdateMaintanceView.xaml
    /// </summary>
    public partial class UpdateMaintanceView : Window
    {
        public UpdateMaintanceView()
        {
            InitializeComponent();
            this.DataContext = new UpdateMaintanceViewModel(this);
        }

        public UpdateMaintanceView(tblClinicMaintance maintance)
        {
            InitializeComponent();
