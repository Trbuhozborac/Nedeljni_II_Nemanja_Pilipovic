...
{
    /// <summary>
    /// Interaction logic for UpdateHospitalView.xaml
    /// </summary>
    public partial class UpdateHospitalView : Window
    {
        public UpdateHospitalView()
        {
            InitializeComponent();
            this.DataContext = new UpdateHospitalViewModel(this);
        }

        public UpdateHospitalView(tblMedicalInstitution institution)
        {
            InitializeComponent();
            this.DataContext = new UpdateHospitalViewModel(this, institution);
        }
