...
namespace Zadatak_1.Views
{
    ...
    /// </summary>
    public partial class UpdateManagerView : Window
    {
        public UpdateManagerView(tblClinicManager updateManager)
        {
            InitializeComponent();
            this.DataContext = new UpdateManagerViewModel(this, updateManager);
        }
